...
swBfoam.CellArrays = ['T', 'vorticity']
...
calculator1 = Calculator(Input=clip3)
...
contour1.ContourBy = ['POINTS', 'magVorticity']
contour1.Isosurfaces = [9000.]
